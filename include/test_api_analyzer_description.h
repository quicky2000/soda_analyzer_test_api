...
*/
#ifndef _TEST_API_ANALYZER_DESCRIPTION_H_
#define _TEST_API_ANALYZER_DESCRIPTION_H_

#include "analyzer_description_if.h"

namespace osm_diff_analyzer_test_api
{
  class test_api_analyzer_description: public osm_diff_analyzer_if::analyzer_description_if
  {
  public:
...
#endif // _TEST_API_ANALYZER_DESCRIPTION_H_
//EOF
